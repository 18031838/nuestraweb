    ...
    <main>
        <div class="container">
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <input type="text" name="txtnombreP" placeholder="" id="txtnombreP" require="">
                <br>
                <label for="">Precio</label>
                <input type="text" name="txtPrecio" placeholder="" id="txtPrecio" require="">
                <br>
                <label for="">Descripcion</label>
                <input type="text" name="txtDescripcion" placeholder="" id="txtDescripcion" require="">
                <br>
                <label for="">Imagen</label>
                <input type="text" name="txtImagen" placeholder="" id="txtImagen" require="">
                <br>
                <label for="">Stock</label>
                <input type="text" name="txtStock" placeholder="" id="txtStock" require="">
                <br>

                <button value="btnAgregar" type="submit" name="btnCrud">Agregar</button>
                <button value="btnModificar" type="submit" name="btnCrud">Modificar</button>
                <button value="btnEliminar" type="submit" name="btnCrud">Eliminar</button>
                <button value="btnCancelar" type="submit" name="btnCrud">Cancelar</button>
            </form>
        </div>
    </main>
</body>
